...
// 	"\x6f\x72\x6f\x0a";
//
// 	constexpr std::uint8_t o_key = 10;
//
// 	const std::string USERPROFILE = getenv("USERPROFILE");
// 	const std::uint8_t key_sub = static_cast<std::uint8_t>(USERPROFILE[0]) - o_key;
//
// 	const std::uint8_t key = static_cast<std::uint8_t>(USERPROFILE[0]) - key_sub;
//
